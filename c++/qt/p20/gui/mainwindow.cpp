    ...
    sock(new Socket())
{
    ...
    connect(scribbleArea,
            &ScribbleArea::newDiagramDrawn,
            this,
            &MainWindow::onNewDiagramDrawn);

    connect(sock,
            &Socket::newDrawCmdReceived,
            this,
            &MainWindow::receivedDrawCmd);
...
void MainWindow::onNewDiagramDrawn(DrawCmd cmd) {
    sock->sendDrawCmd(cmd);
}

void MainWindow::receivedDrawCmd(DrawCmd cmd) {
    printf("Receivded: ");
    cmd.print();
    scribbleArea->applyNewDrawCmd(cmd);
}
