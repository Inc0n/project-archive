/****************************************************************************
** Meta object code from reading C++ file 'scribble-area.h'
**
...
#error "The header file 'scribble-area.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 15), // "newDiagramDrawn"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7), // "DrawCmd"
QT_MOC_LITERAL(4, 38, 3), // "cmd"
QT_MOC_LITERAL(5, 42, 10), // "clearImage"
QT_MOC_LITERAL(6, 53, 5), // "print"
QT_MOC_LITERAL(7, 59, 12), // "toolsClicked"
QT_MOC_LITERAL(8, 72, 11), // "QModelIndex"
QT_MOC_LITERAL(9, 84, 3) // "idx"

    },
    "ScribbleArea\0newDiagramDrawn\0\0DrawCmd\0"
    "cmd\0clearImage\0print\0toolsClicked\0"
    "QModelIndex\0idx"
};
...
void ScribbleArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newDiagramDrawn((*reinterpret_cast< DrawCmd(*)>(_a[1]))); break;
        case 1: _t->clearImage(); break;
        case 2: _t->print(); break;
        case 3: _t->toolsClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ScribbleArea::*)(DrawCmd );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ScribbleArea::newDiagramDrawn)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ScribbleArea::newDiagramDrawn(DrawCmd _t1)
{
