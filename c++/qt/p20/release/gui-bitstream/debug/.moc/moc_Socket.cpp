...
QT_MOC_LITERAL(1, 7, 18), // "newDrawCmdReceived"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7), // "DrawCmd"
QT_MOC_LITERAL(4, 35, 3), // "cmd"
QT_MOC_LITERAL(5, 39, 15), // "onNewConnection"
QT_MOC_LITERAL(6, 55, 11) // "readDrawCmd"

    },
    "Socket\0newDrawCmdReceived\0\0DrawCmd\0"
    "cmd\0onNewConnection\0readDrawCmd"
};
...
void Socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newDrawCmdReceived((*reinterpret_cast< DrawCmd(*)>(_a[1]))); break;
        case 1: _t->onNewConnection(); break;
        case 2: _t->readDrawCmd(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Socket::*)(DrawCmd );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Socket::newDrawCmdReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Socket::newDrawCmdReceived(DrawCmd _t1)
{
